...
def worker_figure(cx, cy, s=1.0, mood="neutral", pose="stand", glasses=True,
    ...
    if pose == "lie":
        ...
        g.append('<g transform="rotate(18 5 130)">')
        g.append(f'<ellipse cx="5" cy="55" rx="40" ry="62" fill="{shirt}" stroke="{INK}" stroke-width="4.5"/>')
        ...
        g.append('<g transform="rotate(22 -10 150)">')
        g.append(f'<ellipse cx="0" cy="70" rx="44" ry="65" fill="{shirt}" stroke="{INK}" stroke-width="4.5"/>')
